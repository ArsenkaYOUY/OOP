...
namespace GraphicalEditor.Controllers
{
    public class PluginLoaderController
    {
        ...
        private void AddPluginButton(IPlugin plugin)
        {
            ...
            string imagePath = $"pack://application:,,,/GraphicalEditor;component/Resources/Images/{plugin.IconPath}";

            //var button = new Button
            //{
            //    Style = (Style)Application.Current.FindResource("ImageButtonStyle"),
            //    Width = 80,
            //    Height = 55,
            //    Content = new Image
            //    {
